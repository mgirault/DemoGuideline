...
<html lang="en">
<head>
    <title>Code coverage report for src/utils/create-config.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> create-config.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (swankyConfigFilePath) {
    // Use the provided configuration object
<span class="cstat-no" title="statement not covered" >    swankyConfig = swankyConfigFilePath;</span>
  } else {
